...
const collection0_enc = getEncoding('@punch-remote/config/hyperdb#0')
...
// '@punch-remote/config-by-name' collection key
...
// '@punch-remote/config-by-name'
const index1 = {
  name: '@punch-remote/config-by-name',
  id: 1,
  encodeKey (record) {
  ...
  encodeIndexKeys (record, context) {
    return [index1_key.encode([record.name, record.key])]
  },
...
function resolveCollection (name) {
  switch (name) {
    case '@punch-remote/config': return collection0
    default: return null
  }
}
...
function resolveIndex (name) {
  switch (name) {
    case '@punch-remote/config-by-name': return index1
    default: return null
  }
}
