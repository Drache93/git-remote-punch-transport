...
// '@punch-local/repos' collection key
...
// '@punch-local/repos' value encoding
const collection0_enc = getEncoding('@punch-local/repos/hyperdb#0')

// '@punch-local/repos' reconstruction function
...
// '@punch-local/repos' key reconstruction function
...
function resolveCollection (name) {
  switch (name) {
    case '@punch-local/repos': return collection0
    default: return null
  }
}
